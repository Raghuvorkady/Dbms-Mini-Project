...
class Account(AbstractBaseUser):
    ...
    USN = models.CharField(max_length=10, null=True, unique=True, blank=True)
    course = models.CharField(max_length=50, null=True, choices=COURSES, blank=True)
    sem = models.PositiveSmallIntegerField(null=True, choices=SEM, blank=True)
    salary = models.CharField(max_length=6, null=True, blank=True)
